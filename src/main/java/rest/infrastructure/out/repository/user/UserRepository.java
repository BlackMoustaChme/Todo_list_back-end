package rest.infrastructure.out.repository.user;
...
public class UserRepository implements IUserRepository {
    ...
    public boolean registerUser(String login, String password, String email) throws Exception {
        try {
            ...
            rest.infrastructure.out.repository.user.EUser eUser = new rest.infrastructure.out.repository.user.EUser();
...
//        "SELECT c FROM Customer c WHERE c.name LIKE :custName")
        ...
        try {
            ...
            userTransaction.begin();
            entityManager.joinTransaction();
            List<rest.infrastructure.out.repository.user.EUser> userList = entityManager.createQuery(query, rest.infrastructure.out.repository.user.EUser.class).setParameter("login", login).setParameter("password", password).getResultList();
            size = userList.size();
            userTransaction.commit();
            entityManager.close();
        } catch (Exception e) {
